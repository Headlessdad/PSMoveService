...
void WinUSBApi::close_usb_device(USBDeviceState* device_state)
{
	if (device_state != nullptr)
	{
		...
		{
			SERVER_LOG_INFO("WinUSBApi::close_usb_device") << "Close USB interface handle " << winusb_device_state->interface_handle;
            WinUsb_Free(winusb_device_state->interface_handle);            
		}

		if (winusb_device_state->device_handle != nullptr)
		{
            SERVER_LOG_INFO("WinUSBApi::close_usb_device") << "Close USB device handle " << winusb_device_state->device_handle;
